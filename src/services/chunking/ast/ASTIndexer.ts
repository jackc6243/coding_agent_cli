...
//     if (hasErrors) {
//       this.logger.log(
//         `Parse errors detected in ${filePath}, but continuing with error-tolerant parsing`,
//         "warn"
//       );
//     }

//     const nodes = this.extractNodesFromTree(
//       tree,
//       filePath,
//       fileContent,
//       language
...
//         const astNode = this.createASTNodeFromSyntaxNode(
//           node,
//           filePath,
//           content,
//           language,
...
//     return (
//       semanticTypes[language as keyof typeof semanticTypes]?.includes(
//         nodeType
//       ) || false
//     );
//   }
...
//     const validIdentifiers = identifierTypes[
//       language as keyof typeof identifierTypes
//     ] || ["identifier"];
...
//         !child.type.includes("type_parameter")
//       ) {
//         signature += ": " + child.text;
//       }
//     }
...
//         signature += child.text;
//       } else if (
//         child.type.includes("extends") ||
//         child.type.includes("implements") ||
//         child.type.includes("heritage")
//       ) {
//         signature += " " + child.text;
